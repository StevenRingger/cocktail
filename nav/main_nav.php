...
// by Steven Ringger
// aquire session info
  include $_SERVER['DOCUMENT_ROOT'].'/cocktailGit/sites/user_management/session.php';  
  require_once $_SERVER['DOCUMENT_ROOT'].'/cocktailGit/sites/user_management/user_info.php';
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="/cocktailGit/index.php">Cocktails Inc.</a>
    </div>
        ...
        // if user is not set display register and login buttons
          ...
          //if user is seet display userpage link and logout button       
            if ($user['role']==1) {
              ...
              echo '<li><a href="/cocktailGit/index.php?action=add">Add cocktail</a></li>';
            }
            echo '<li><a href="?action=user">'.$user['firstname'] . ' ' .$user['lastname'].'</a></li>';
            echo '<li><a href="/cocktailGit/sites/user_management/logout.php">Logout</a></li>';
          }
         ?>
      </ul>
    </div>
